...
public extension Asset {
    ...
    enum Icons {
        ...
        public static let arrowInToRectangle = ThemeIcon(iconProviderKeyPath: \.arrowInToRectangle)
        ...
        public static let arrowRotateRight = ThemeIcon(iconProviderKeyPath: \.arrowRotateRight)
        public static let arrowsSwitch = ThemeIcon(iconProviderKeyPath: \.arrowsSwitch)
        public static let arrowUpBounceLeft = ThemeIcon(iconProviderKeyPath: \.arrowUpBounceLeft)
        ...
        public static let bug = ThemeIcon(iconProviderKeyPath: \.bug)
        ...
        public static let circleHalfFilled = ThemeIcon(iconProviderKeyPath: \.circleHalfFilled)
        public static let circleSlash = ThemeIcon(iconProviderKeyPath: \.circleSlash)
        public static let code = ThemeIcon(iconProviderKeyPath: \.code)
        ...
        public static let gift = ThemeIcon(iconProviderKeyPath: \.gift)
        public static let globe = ThemeIcon(iconProviderKeyPath: \.globe)
        public static let grid2 = ThemeIcon(iconProviderKeyPath: \.grid2)
        ...
        public static let keySkeleton = ThemeIcon(iconProviderKeyPath: \.keySkeleton)
        public static let lifeRing = ThemeIcon(iconProviderKeyPath: \.lifeRing)
        public static let lockOpen = ThemeIcon(iconProviderKeyPath: \.lockOpen)
        public static let lock = ThemeIcon(iconProviderKeyPath: \.lock)
        ...
        public static let shieldHalfFilled = ThemeIcon(iconProviderKeyPath: \.shieldHalfFilled)
        public static let sliders = ThemeIcon(iconProviderKeyPath: \.sliders)
        public static let star = ThemeIcon(iconProviderKeyPath: \.star)
        public static let switchOff = ThemeIcon(iconProviderKeyPath: \.switchOff)
        public static let switchOn = ThemeIcon(iconProviderKeyPath: \.switchOn)
        public static let threeDotsVertical = ThemeIcon(iconProviderKeyPath: \.threeDotsVertical)
        public static let user = ThemeIcon(iconProviderKeyPath: \.user)
        public static let users = ThemeIcon(iconProviderKeyPath: \.users)
